...
export const it = {
  ...
  "settings.geotagging": "Posizione dei rilevamenti",
  "settings.geotagging.on": "Geolocalizzazione attiva",
  "settings.geotagging.off": "Geolocalizzazione disattivata",
  "settings.geotagging.hint": "Registra dove hai visto ogni segnale. Tienilo presente: lo storico diventa una mappa dei posti che frequenti. Resta tutto sul telefono.",
  "settings.geotagging.denied": "Permesso di localizzazione negato. Puoi concederlo dalle impostazioni del telefono.",
  "settings.geotagging.no_fix": "Nessun segnale GPS al momento. Al chiuso capita spesso: i rilevamenti vengono salvati senza posizione.",
  "settings.geotagging.unsupported": "Questo dispositivo non offre la geolocalizzazione.",
  "settings.geotagging.disabled": "Disattivata.",
